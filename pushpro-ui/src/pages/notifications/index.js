...
const Notifications = () => {
  ...
  const handleNotificationClose = async (notificationId, project_id) => {
    try {
                ...
                <Row className="mb-1">
                  ...
                  <Col xl={3} md={3} sm={6} xs={12} className="mb-xl-1">
                    ...
                    <InputGroup className="d-inline-block">
                      <Select
                        key={`notification-type-select-${selectedTypes.length}`}
                            ...
                            <div className="lh-1">
                              <span className="avatar avatar-md me-3 avatar-rounded">
                                <img
                                  alt="avatar"
                                  src={
                                    notification.project.customer.profile_url
                                      ? `${s3BasePath}${notification.project.customer.profile_url}`
