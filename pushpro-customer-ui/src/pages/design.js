        ...
        <div className="main-parent">
          ...
          <div className="mb-4 d-xl-none logo-center">
            <a href="/register/#">
              <div className="">
                <img
                  src={`${assetPrefix}/assets/images/brand-logos/desktop-logo.png`}
                  alt=""
                  className="authentication-brand desktop-logo logo-size m-0"
                />
              </div>
            </a>
          </div>
                  ...
                  <div className="p-5 same-pad">
                    ...
                    <div className="row gy-3 mt-4">
                      <div className=" mb-3 col-xl-12 extra-mar">
                        <label
                          className="form-label auth-field-color form-label"
                        ...
                        <div className="input-group">
                          <input
                            ...
                            type="text"
                            id="signup-firstname"
                            className="form-control-lg dark-input auth-input-color form-control"
                          />
                        </div>
                      </div>
                      <div className=" mb-3 col-xl-12 extra-mar">
                      ...
                      <div className="mb-3 col-xl-12 extra-mar">
                        <label
                          className="form-label d-block auth-field-color form-label"
                          for="signup-password"
                        >
                          Password
                        </label>
                        <div className="input-group">
                          ...
                          >
                            <i
                              className="ri-eye-off-line align-middle"
                              aria-hidden="true"
                            ></i>
                          </button>
                        </div>
                      ...
                      <div className="col-xl-12 d-grid mt-2">
                        <button className="btn btn-lg btn-primary btn-style">
                          Create Account
                        </button>
                      </div>
                    </div>
