...
const MyProjects = () => {
  ...
  const { delete: del, handleSuccessDialog, handleErrorDialog } = useService();
  ...
  }, [router.query, currentPage, pageSize, contId]);
  ...
  const reset = async () => {
    const waitForStatusUpdate = new Promise((resolve) => {
          ...
          <div className="col-xl-3 col-md-3">
            ...
            <InputGroup>
              <Form.Control
                ...
                placeholder={t("project.projectTitle")}
                aria-label="search"
                autoComplete="off"
        ...
        <div className="row">
          <div className="table-responsive rounded p-0">
            <table className="table table-bordered border text-muted border-2 rounded">
              <thead>
                <tr>
                  <th width="20%">{t("certificatesForm.title")}</th>
                  ...
                  projects.map((project, index) => (
                    <tr key={index}>
                      ...
                      <td>
                        ...
                        ></span>{" "}
                        : <span>{t("project.startsFrom")} - </span>{" "}
                        {project.start_date
