...
import { Card, InputGroup, Accordion, Spinner } from "react-bootstrap";
            ...
            <div className="chat-info border">
              ...
              {activeKey === "" && (
                <div className="main-chat-area border" ref={chatContentRef}>
                  <div className="d-flex align-items-center p-2 chatHeaderLightBackground border-bottom">
                  ...
                  <div className="chat-footer chatHeaderLightBackground pb-3 row p-0 m-0 mb-5 gy-1">
