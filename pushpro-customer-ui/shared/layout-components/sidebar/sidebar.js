...
const Sidebar = ({ local_varaiable, ThemeChanger }) => {
  ...
  const [toggleLogoPath, setToggleLogoPath] = useState("");
  useEffect(() => {
  ...
  useEffect(() => {
    ...
    const toggleLogo = localStorage.getItem("toggleLogo");
    if (toggleLogo) {
      setToggleLogoPath(toggleLogo);
    } else {
      setToggleLogoPath(logoPath);
    }
                        ...
                        >
                          ...
                          >
                            <li className="slide side-menu__label1">
                              <Link href="#!">{secondlayer.title}</Link>
                            </li>
